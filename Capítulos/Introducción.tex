...
\begin{table}[h!]
    \centering
    \small
    \caption{Parámetros estructurales reportados en trabajos experimentales para agua.}
    \label{tab:trabajos_experimentales_agua}
    
    % Usamos 'm{ancho}' para centrado vertical. 
    % La suma de anchos debe ser cercana a \linewidth.
    \begin{tabular}{| C{0.7cm} | C{1.5cm} | C{0.6cm} | C{2.5cm} | C{1.8cm} | C{1.8cm} | C{1.8cm} | C{1.8cm} |}
        \hline
        \textbf{Ref} & \textbf{Técnica} & \textbf{NC} & \textbf{Geometría} & \textbf{\ce{O_{eq1}} (\AA)} & \textbf{\ce{O_{eq2}} (\AA)} & \textbf{\ce{O_{ax1}} (\AA)} & \textbf{\ce{O_{ax2}} (\AA)} \\ 
        \hline
        
        \cite{Wa-2020-01} & EXAFS & 6 & Octaédrica distorsionada & $1.975 \pm 0.003$ & & $2.14 \pm 0.02$ & $2.32 \pm 0.02$ \\ 
        \hline
        
        \multirow{4}{*}{\cite{Wa-2018-02}} & EXAFS & 6 & Asimétrica axial & $1.97$ & & $2.22$ & $2.34$ \\ 
        \cline{2-8}
        
        & \multirow{3}{*}{MXAN} & 5 & Pirámide cuadrada & $1.95$ & & $2.23$ & \\ 
        \cline{3-8} 
        
        & & 6 & Asimétrica axial & $1.94$ & $1.94$ & $2.22$ & \\ 
        \cline{3-8} 
        
        & & 6 & Asimétrica axial & $1.94$ & $2.14$ & $2.28$ & \\ 
        \hline
    \end{tabular}
\end{table}
