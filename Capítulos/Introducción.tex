...
\section{Hidratación}
    ...
    Los primeros trabajos de difracción en las décadas de 1970 y 1980 establecieron la idea de una coordinación octaédrica distorsionada, con una configuración (4+2) que implica cuatro ligandos de agua en posiciones ecuatoriales y dos más distantes en posiciones axiales \cite{Wa-1988-01}. Sin embargo, a partir del año 2000, estudios más avanzados, que combinaban técnicas como la difracción de neutrones con dinámica molecular o emplean análisis de EXAFS y XANES más sofisticados, comenzaron a favorecer un modelo de coordinación quíntuple (NC=5) con una geometría de pirámide cuadrada \cite{Wa-2001-01, Wa-2002-01}.

    Actualmente, existe un consenso experimental sobre las distancias de enlace ecuatoriales ($Cu-O_{eq}$), que se reportan consistentemente en el rango de 1.93--2.01 \AA. Por el contrario, las distancias axiales ($Cu-O_{ax}$) son más difíciles de medir y presentan una mayor variabilidad, con valores que oscilan entre 2.15 \AA \ y 2.60 \AA. Investigaciones recientes de alta resolución sugieren incluso la existencia de dos distancias axiales distintas, lo que apunta a un octaedro no centrosimétrico. Algunos estudios que emplean un enfoque experimental y teórico han llegado a proponer un NC promedio de 4.5, lo que refuerza la idea de una mezcla dinámica de geometrías en solución. La imagen moderna, por tanto, describe una "plasticidad estructural" donde múltiples estados de coordinación coexisten en un equilibrio dinámico. El resumen de todos estos trabajos se encuentra en la tabla \ref{tab:trabajos_experimentales_agua}.

    \begin{table}[h!]
        \centering
        \small
        \caption{Parámtros estructurales reportados en trabajos experimentales para agua.}
        \label{tab:trabajos_experimentales_agua}
        \begin{tabular}{|l|l|c|l|l|l|l|l|}
            \hline
            \textbf{Ref} &\textbf{Técnica} & \textbf{NC} & \textbf{Geometría} & \textbf{\ce{O_{eq1}} (\AA)} & \textbf{\ce{O_{eq2}} (\AA)} & \textbf{\ce{O_{ax1}} (\AA)} & \textbf{\ce{O_{ax2}} (\AA)} \\ \hline
            \cite{Wa-2020-01} & EXAFS & 6 & octaédrica distorsionada & $1.975 \pm 0.003$ & & $2.14 \pm 0.02$ & $2.32 \pm 0.02$ \\ \hline
            \multirow{4}{*}{\cite{Wa-2018-02}} & EXAFS & 6 & Asimétrica axial & $1.97$ & & $2.22$ & $2.34$ \\ \cline{2-8}
            &\multirow{3}{*}{MXAN} & 5 & Pirámide cuadrada & $1.95$ & & $2.23$ & \\ \cline{3-8} 
            & &6 & Asimétrica axial & $1.94$ & $1.94$ & $2.22$ & \\ \cline{3-8} 
            & &6 & Asimétrica axial & $1.94$ & $2.14$ & $2.28$ & \\ \hline
        \end{tabular}
    \end{table}
