...
El algoritmo de Velocity-Verlet es actualmente uno de los más populares y ampliamente utilizados en las simulaciones de MD. Se obtiene a partir de una expansión de Taylor de las posiciones y velocidades 
...
Esto garantiza que la simulación comience desde una configuración físicamente razonable, con fuerzas moderadas, permitiendo un inicio de la dinámica estable. 
