...
La función de distribución radial (RDF, por sus siglas en inglés) es una herramienta estadística fundamental en el análisis de sistemas moleculares y materiales. Proporciona información sobre la estructura local alrededor de un átomo o molécula de referencia, describiendo cómo varía la densidad de partículas en función de la distancia desde este punto de referencia. La RDF, denotada como \( g(r) \), se define matemáticamente como:
\begin{equation}
