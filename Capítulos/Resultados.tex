...
\begin{figure}[H]
    ...
    \caption[RDF para \ce{[Cu(H2O)40]^{2+}}]{Función de distribución radial (RDF) obtenida para el sistema \ce{[Cu(H2O)40]^{2+}} a partir de la simulación de dinámica molecular.}
    \label{fig:rdf_agua}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Frecuencia del número de coordinación del ion obtenida a partir de la trayectoria (60\,391 frames, $r = 2.833$~\AA).}
...
\begin{figure}[htbp]
    ...
    \caption[Geometrías representativas de la primera esfera de coordinación en
    \ce{[Cu(H2O)_{40}]^{2+}}]{Geometrías representativas observadas en la primera esfera de
...
\begin{figure}[htbp]
    ...
    \caption[Evolución de distancias \ce{Cu-O} — moléculas protagonistas]{
...
\begin{figure}[htbp]
    ...
    \caption[RDF para \ce{[Cu(CH3OH)40]^{2+}}]{Función de distribución radial (RDF) obtenida para el sistema \ce{[Cu(CH3OH)40]^{2+}} a partir de la simulación de dinámica molecular.}
...
\begin{figure}[H]
    ...
    \caption{Frecuencia del número de coordinación del ion obtenida a partir de la trayectoria (68\,073 frames, $r = 3.023$~\AA).}
...
\begin{figure}[H]
    ...
    \caption[ADF para \ce{[Cu(CH3OH)40]^{2+}}]{Función de distribución angular (ADF) obtenida para el sistema \ce{[Cu(CH3OH)40]^{2+}} a partir de la simulación de dinámica molecular.}
...
\begin{figure}[htbp]
    ...
    \caption[Geometrías representativas de la primera esfera de coordinación en
    \ce{[Cu(CH3OH)_{40}]^{2+}}]{Geometrías representativas observadas en la primera esfera de
...
\begin{figure}[htbp]
    ...
    \caption[Evolución de distancias \ce{Cu-O} — sistema \ce{[Cu(CH3OH)40]^{2+}}]{Evolución temporal de las distancias \ce{Cu^{2+}}--O para las 9 moléculas de metanol de mayor interés en el cúmulo \ce{[Cu(CH3OH)_{40}]^{2+}}. La línea punteada indica el radio de corte $r_\text{corte} = 3.023$~\AA.}
