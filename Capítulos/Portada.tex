...
\begin{titlepage}
    ...
    \begin{minipage}[c][0.81\textheight][t]{0.75\textwidth}
        \begin{center}
            ...
            {\large\scshape Estudio de la solvatación del ion Cu\textsuperscript{2+} en agua y metanol mediante dinámica molecular ab initio}\\[.2in]
            ...
            \large{Ciudad Universitaria, CDMX}{ }{2026}
        \end{center}
    \end{minipage}
\end{titlepage}
